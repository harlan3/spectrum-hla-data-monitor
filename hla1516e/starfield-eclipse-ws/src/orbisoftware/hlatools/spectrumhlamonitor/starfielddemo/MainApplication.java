...
public class MainApplication {
	...
	private static void printUsage() {
		...
		System.out.println("Usage: hla-starfield-demo [OPTION]...");
		System.out.println("Run the hla-starfield-demo");
		System.out.println();
	...
	public static void main(String[] args) {
		...
		try {
			...
			javax.swing.SwingUtilities.invokeLater(() -> {
				...
				JFrame frame = new JFrame("StarField Demo - " + federateValue + " - HLA 1516e");
				frame.setSize(800, 600);
				frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

				StarFieldModel starField = new StarFieldModel();
				frame.add(starField);
				frame.setFocusable(true);
				frame.setVisible(true);
				frame.addKeyListener(starField);
