...
export CP="./dist/star_field.jar:./lib/hla1516_fom_objs.jar:/rtis_D39/lib/x86_64_g++-11.2/rtis1516e.jar"

$JAVA_CMD $VM_OPTIONS -cp $CP orbisoftware.hlatools.spectrumhlamonitor.starfielddemo.MainApplication "$@"
