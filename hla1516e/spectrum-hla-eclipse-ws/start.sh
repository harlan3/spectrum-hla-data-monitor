...
export CP="./dist/spectrum-hla-data-monitor.jar:./lib/container_classes.jar:./lib/encoding_classes.jar:./lib/outline.jar:./lib/gson-2.14.1.jar:./lib/org-json.jar:/rtis_D39/lib/x86_64_g++-11.2/rtis1516e.jar"
