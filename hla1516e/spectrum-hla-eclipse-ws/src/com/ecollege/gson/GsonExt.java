...
/**
 * An uninstantiable class offering foreign convenience methods to convert
 * between JSON and XML strings.
 * 
 * @author toddf
 * @since Jun 7, 2010
 */
public final class GsonExt {
   ...
   public static String toJson(String xml) throws XmlParseException {
      return toJson(parseXml(xml));
   }

   public static JsonElement parseXml(String xml) throws XmlParseException {
      return new Xml().parse(xml);
   }

   public static String toXml(String json) throws JsonParseException {
