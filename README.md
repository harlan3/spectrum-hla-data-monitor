...
Samples defined as HLA objects and interactions instantiations can be modified and injected through the graphical user interface. The project also includes a bulk data producer (the solarsystem project), which can generate HLA objects and interactions for the Spectrum HLA Data Monitor.
