...
Sample data which consists of the payload of HLA objects and interactions can be modified and injected through the graphical user interface. The project also includes bulk data producers (the starfield and solarsystem projects), which can generate HLA objects and interactions that are viewable by the Spectrum HLA Data Monitor.
