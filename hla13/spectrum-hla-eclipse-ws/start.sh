...
export CP="./dist/spectrum-hla-data-monitor.jar:./lib/hla13_fom_objs.jar:./lib/outline.jar:./lib/gson-2.14.1.jar:./lib/org-json.jar:/rtis_D39/lib/x86_64_g++-11.2/rtis13.jar"
