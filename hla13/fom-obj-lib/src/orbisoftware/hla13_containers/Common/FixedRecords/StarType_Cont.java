...
public class StarType_Cont {
   ...
   public double projX = 0.0;
   public double projY = 0.0;
   public double projZ = 0.0;
   public double size = 0.0;
   public double speed = 0.0;
   public double blinkSpeed = 0.0;
   public double blinkPhase = 0.0;
   public double alpha = 0.0;

   // Constructor
   public StarType_Cont() {
